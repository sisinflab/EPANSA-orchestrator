...
#TMP_DIR = "../../data/tmp"     # FOR LOCAL TESTING PURPOSES ONLY

EXTRACTION_MODEL_NAME = os.getenv("EXTRACTION_MODEL_NAME")
EXTRACTION_LLM_CONFIG = os.getenv(f"EXTRACTION_LLM_CONFIG")
...
RECOMMENDER_LLM_CONFIG = os.getenv("RECOMMENDER_LLM_CONFIG")
