...
async def run_for_user(user_id: str, request: Request, backfill: bool, _=Depends(jwt_dependency)):
...
async def run_for_all_users(request: Request, backfill: bool = False, _=Depends(jwt_dependency)):
